...
one sig app_ForgivingSecurity extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_ForgivingSecurity.contacts
  attribute    = cap_contactSensor_attr_contact
  value        = cap_contactSensor_attr_contact_val_open
}
one sig r0_trig1 extends r0_trig {} {
  capabilities = app_ForgivingSecurity.motions
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_ForgivingSecurity.state
  attribute    = cap_state_attr_triggerMode
  value        = cap_state_attr_triggerMode_val_not_null
}
one sig r0_comm1 extends r0_comm {} {
  capability   = app_ForgivingSecurity.state
  attribute    = cap_state_attr_lastTrigger
  value        = cap_state_attr_lastTrigger_val_not_null
}
*/
...
one sig r1_cond0 extends r1_cond {} {
  capabilities = app_ForgivingSecurity.location
  attribute    = cap_location_attr_mode
  value        = cap_state_attr_triggerMode_val_not_null
}
*/
one sig r1_cond1 extends r1_cond {} {
  capabilities = app_ForgivingSecurity.state
  attribute    = cap_runIn_attr_runIn
  value        = cap_runIn_attr_runIn_val_on
}
...
one sig r1_comm0 extends r1_comm {} {
  capability   = app_ForgivingSecurity.lights
  attribute    = cap_switch_attr_switch
  value        = cap_switch_attr_switch_val_on
}
one sig r1_comm1 extends r1_comm {} {
  capability   = app_ForgivingSecurity.alarms
