...
one sig app_HumidityControl extends IoTApp {
...
one sig r11_trig0 extends r11_trig {} {
  capabilities = app_HumidityControl.sensor
...
one sig r11_cond0 extends r11_cond {} {
  capabilities = app_HumidityControl.mode
...
one sig r11_comm0 extends r11_comm {} {
  capability   = app_HumidityControl.outlets
...
one sig r12_trig0 extends r12_trig {} {
  capabilities = app_HumidityControl.motion
...
one sig r12_cond3 extends r12_cond {} {
  capabilities = app_HumidityControl.sensor
  attribute    = cap_temperatureMeasurement_attr_temperature
  //value        = cap_temperatureMeasurement_attr_temperature_val - cap_temperatureMeasurement_attr_temperature_val_null
