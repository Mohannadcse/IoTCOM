module app_ImprovedSmartNightLight
...
one sig app_ImprovedSmartNightLight extends IoTApp {
  
  lights : some cap_switch,
  
  powerSwitch : one cap_switch,
  ...
  rules = r
  //capabilities = lights + powerSwitch + motionSensor + lightSensor + state
}
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_ImprovedSmartNightLight.motionSensor
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_ImprovedSmartNightLight.state
  attribute    = cap_motionStopTime_attr_motionStopTime
  value        = cap_motionStopTime_attr_motionStopTime_val_null
}
...
one sig r1_comm0 extends r1_comm {} {
  capability   = app_ImprovedSmartNightLight.state
  attribute    = cap_motionStopTime_attr_motionStopTime
  value        = cap_motionStopTime_attr_motionStopTime_val_not_null
}
*/
...
one sig r2_trig0 extends r2_trig {} {
  capabilities = app_ImprovedSmartNightLight.lightSensor
...
one sig r2_cond0 extends r2_cond {} {
  capabilities = app_ImprovedSmartNightLight.state
...
one sig r2_cond1 extends r2_cond {} {
  capabilities = app_ImprovedSmartNightLight.lightSensor
  attribute    = cap_illuminanceMeasurement_attr_illuminance
  //value        = cap_illuminanceMeasurement_attr_illuminance_val_range_2
  value        = range_2
}
...
one sig r2_comm0 extends r2_comm {} {
  capability   = app_ImprovedSmartNightLight.lights
...
one sig r4_cond1 extends r4_cond {} {
  capabilities = app_ImprovedSmartNightLight.powerSwitch
  attribute    = cap_switch_attr_switch
...
one sig r5_cond1 extends r5_cond {} {
  capabilities = app_ImprovedSmartNightLight.state
  attribute    = cap_state_attr_motionStopTime
  value        = cap_state_attr_motionStopTime_val_no_value
}
*/
...
one sig r5_cond4 extends r5_cond {} {
  capabilities = app_ImprovedSmartNightLight.lightSensor
  attribute    = cap_illuminanceMeasurement_attr_illuminance
...
/*
one sig r7_cond4 extends r7_cond {} {
  capabilities = app_ImprovedSmartNightLight.state
  attribute    = cap_state_attr_motionStopTime
  value        = cap_state_attr_motionStopTime_val_not_null
}
