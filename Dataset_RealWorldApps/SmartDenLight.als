...
one sig app_SmartDenLight extends IoTApp {
  ...
  rules = r
  //capabilities = lights + motionSensor + state
}
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_SmartDenLight.motionSensor
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_SmartDenLight.lights
  attribute    = cap_switch_attr_switch
  value        = cap_switch_attr_switch_val_on
}
one sig r0_comm1 extends r0_comm {} {
  capability   = app_SmartDenLight.state
