...
one sig app_Unlockdoor extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_Unlockdoor.app
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_Unlockdoor.locks
...
one sig r1_trig0 extends r1_trig {} {
  capabilities = app_Unlockdoor.location
