...
public class P18Converter extends ThreatConverter {

	@Override
	public String convert(Graph<String, DefaultEdge> connected, Node xml) throws Exception {
		// for P18, we want to find two skolems: r and predecessor
		String r_ = xpath.findStr("//skolem[@label=\"$P18_r\"]/tuple/atom/@label", xml);
		String p_ = xpath.findStr("//skolem[@label=\"$P18_predecessor\"]/tuple/atom/@label", xml);
		...
		return build("P18", apps, configs, event, xml);
	}
