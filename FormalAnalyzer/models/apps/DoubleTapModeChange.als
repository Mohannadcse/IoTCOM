...
one sig cap_state_attr_mode_val_downMode extends cap_state_attr_mode_val {}
...
one sig r0_cond1 extends r0_cond {} {
  ...
  value        = cap_location_attr_mode_val - app_DoubleTapModeChange.upMode
}
...
one sig r0_comm0 extends r0_comm {} {
  ...
  attribute = cap_location_attr_mode
  value        = app_DoubleTapModeChange.upMode
}
...
one sig r1_comm0 extends r1_comm {} {
  capability   = app_DoubleTapModeChange.state
...
one sig r2_cond2 extends r2_cond {} {
  capabilities = app_DoubleTapModeChange.location
  attribute    = cap_location_attr_mode
  value        = cap_location_attr_mode_val - app_DoubleTapModeChange.downMode
}
...
one sig r2_comm0 extends r2_comm {} {
  capability   = app_DoubleTapModeChange.location
  attribute = cap_location_attr_mode
  value        = app_DoubleTapModeChange.downMode
}
