...
one sig app_GDoor extends IoTApp {
  ...
  rules = r
  //capabilities = doorSensor + doorSwitch + cars + carDoorSensors + interiorDoorSensor + state
}
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_GDoor.doorSensor
...
one sig r1_comm0 extends r1_comm {} {
  ...
  value        = cap_state_attr_appOpenedDoor_val - cap_state_attr_appOpenedDoor_val_0
}
/*
...
one sig r2_cond0 extends r2_cond {} {
  capabilities = app_GDoor.userInput
  attribute    = cap_userInput_attr_openThreshold
  value        = cap_userInput_attr_openThreshold_val_no_value
}
...
one sig r4_comm0 extends r4_comm {} {
  capability   = app_GDoor.doorSwitch
...
one sig r6_trig0 extends r6_trig {} {
  capabilities = app_GDoor.interiorDoorSensor
  attribute    = cap_contactSensor_attr_contact
  value        = cap_contactSensor_attr_contact_val_closed
}
...
one sig r7_trig0 extends r7_trig {} {
  capabilities = app_GDoor.carDoorSensors
