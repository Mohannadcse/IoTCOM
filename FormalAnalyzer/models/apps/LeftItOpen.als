...
one sig app_LeftItOpen extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_LeftItOpen.contact
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_LeftItOpen.state
...
one sig r1_cond0 extends r1_cond {} {
  capabilities = app_LeftItOpen.state
  attribute    = cap_state_attr_runIn
  value        = cap_state_attr_runIn_val_on
}
one sig r1_cond1 extends r1_cond {} {
  ...
  value        = cap_state_attr_motionStopTime_val//_not_null
}
